...
**Hinweis:** Wenn Sie eine On-Premise- oder Hybrid-Bereitstellung benötigen, steht Campaign Classic v7 weiterhin mit voller Unterstützung zur Verfügung.
...
* **Workflow-Protokolle** - Zugriff auf detaillierte Ausführungsprotokolle zur Fehlerbehebung
* **Heatmap** - Visualisieren der Workflow-Aktivität und Ermitteln von Leistungsengpässen
* **[Audit-Protokoll](../reporting/audit-trail.md)** - Verfolgen Sie alle Änderungen an Workflows
* **Warnhinweise** - Einrichten von Benachrichtigungen bei Fehlern oder Verzögerungen bei Workflows
