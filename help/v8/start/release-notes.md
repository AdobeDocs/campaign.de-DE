...
Als Kunde müssen Sie außerdem sicherstellen, dass Sie die neueste unterstützte Version der Systeme verwenden, die im Abschnitt [Kompatibilitätsmatrix](compatibility-matrix.md).
