...
* [Versandwarnung](https://experienceleague.adobe.com/docs/campaign-web/v8/msg/delivery-alerting/delivery-alerting.html){target="_blank"}
...
* Behebung eines Absturzproblems in Workflows mithilfe von `CCurlAzureBlobStorage::UploadStream`. Die Workflows werden jetzt beim Hochladen von Azure Blob Storage ohne Segmentierungsfehler ausgeführt. (NEO-79598)
