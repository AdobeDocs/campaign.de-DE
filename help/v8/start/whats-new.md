...
[Erfahren Sie mehr über das Kundendatenmanagement](audiences.md)
...
[Erfahren Sie mehr über die Kampagnenverwaltung](campaigns.md)
...
[Weitere Informationen zu Campaign-Integrationen](../connect/integration.md)
...
[!BADGE PDF]{type=Informative}[Lesen Sie dieses Whitepaper](assets/do-not-localize/IDC-Report-BusinessValueOfAdobeCampaign.pdf){target="_blank"}, um mehr über den Geschäftswert von Adobe Campaign Managed Cloud Services zu erfahren.
...
[Erfahren Sie mehr über die Bereitstellung von Enterprise (FFDA)](../architecture/enterprise-deployment.md)
