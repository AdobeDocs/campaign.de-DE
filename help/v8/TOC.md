...
+ Versionshinweise {#releases}
   + {hide-from-toc}[Frühzeitige Versionshinweise](start/e-release-notes.md)
   + [Versionen und Upgrades](start/upgrades.md)
   + [Neueste Versionen](start/release-notes.md)
   + Frühere Versionen {#previous-rn}
   ...
   + {hide-from-toc}[Bekannte Probleme](start/known-issues.md)
   + [Kompatibilitätsmatrix](start/compatibility-matrix.md)
   + {hide-from-toc}[Aktualisierungen der Dokumentation](start/documentation-updates.md)
+ Erste Schritte {#new}
   ...
   + {hide-from-toc}[Häufig gestellte Fragen](start/campaign-faq.md)
   + {hide-from-toc}[E-Mail-Tracking-Pixel und CNIL-Anleitung](start/cnil-pixel-tracking.md)
+ Administration und Berechtigungen {#permissions}
...
+ Nachrichten senden {#send}
   ...
   + E-Mails {#emails}
      ...
      + [Definieren interaktiver Inhalte](send/defining-interactive-content.md)
   ...
   + Verwaltung der Zustellbarkeit {#deliverability-management}
      ...
      + [Rendern des Posteingangs](send/inbox-rendering.md)
...
+ Profile und Zielgruppen {#audience}
   ...
   + [Arbeiten mit Filtern](audiences/create-filters.md)
   ...
   + Zielgruppen erstellen {#create-audiences}
      ...
      + {hide-from-toc}[Audiences mit Adobe-Lösungen freigeben](start/shared-audiences.md)
...
+ Angebotsverwaltung - Interaction {#offers}
   ...
   + Konfigurationseinstellungen {#interaction-settings}
...
+ Konfiguration {#config}
   ...
   + Einstellungen {#settings}
      ...
      + {hide-from-toc}[Campaign SDKs mit Ihrer Mobile App integrieren - VERALTETE SEITE](config/push-config.md)
...
+ Ressourcen für Entwickelnde {#developer}
   ...
   + REST APIs {#apis}
      ...
      + [Empfehlungen und Einschränkungen](dev/api/limitations.md)
      + [Verwendung von REST-APIs](dev/api/why-using-campaign-standard-apis.md)
      + [Einrichten von API-Zugriff](dev/api/setting-up-api-access.md)
      + Globale Konzepte {#global-concepts}
         + [Grundlegende Konzepte](dev/api/must-read.md)
         + [Endpunkte](dev/api/endpoints.md)
         + [Metadatenmechanismus](dev/api/metadata-mechanism.md)
         + [Verben](dev/api/verbs.md)
         + [Zusätzliche Vorgänge](dev/api/sorting.md)
         + [Benutzerdefinierte Ressourcen](dev/api/custom-resources.md)
      + [Interaktion mit benutzerdefinierten Ressourcen](dev/api/interacting-with-custom-resources.md)
      ...
      + Services und Abonnements verwalten {#managing-services-and-subscriptions}
         ...
         + [Löschen von Abonnements](dev/api/deleting-subscriptions.md)
      + [Verwalten von Transaktionsnachrichten](dev/api/managing-transactional-messages.md)
      + Workflows verwalten {#managing-workflows}
         + [Steuern eines Workflows](dev/api/controlling-a-workflow.md)
