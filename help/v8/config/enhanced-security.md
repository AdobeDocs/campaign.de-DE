...
Cloud-Datenbanken werden unterstützt. Weitere Informationen finden Sie in der [Kompatibilitätsmatrix](../start/compatibility-matrix.md#FederatedDataAccessFDA).
