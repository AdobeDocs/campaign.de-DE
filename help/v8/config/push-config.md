...
Unterstützte Versionen von Android und iOS sowie mit Campaign SDKs kompatible Versionen für Campaign v8 sind in der [Kompatibilitätsmatrix](../../rn/using/compatibility-matrix.md#MobileSDK) aufgeführt.
