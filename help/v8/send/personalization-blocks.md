...
* **[!UICONTROL Formatierungsfunktion für Eigennamen]**: Hiermit wird die JavaScript-Funktion **[!UICONTROL toSmartCase]** generiert, durch die der erste Buchstabe eines jeden Worts in einen Großbuchstaben umgewandelt wird.
...
* **[!UICONTROL Anmelde-Link (mit Werber)]**: Hiermit wird ein Anmelde-Link eingefügt, über den die Besucherin bzw. der Besucher sowie der Versand identifiziert werden können. Dieser Link wird in den Instanzeinstellungen definiert.
