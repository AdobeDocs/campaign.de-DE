...
Weitere Informationen zu [Versandstatus](delivery-statuses.md).
...
Adobe Campaign verwendet den **Enhanced MTA** (Mail Transfer Agent), eine leistungsstarke E-Mail-Versand-Engine.
