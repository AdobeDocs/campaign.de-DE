...
Adobe Campaign unterstützt zwei SMS-Connectoren, die zum Senden von SMS-Nachrichten an Ihre Kunden verwendet werden. [Weitere Informationen](sms-connectors.md).
